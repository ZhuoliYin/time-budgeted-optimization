...
def args2dict(args):
    env_params = {"problem_size": args.problem_size, "num_vehicles": args.num_vehicles, "pomo_size": args.pomo_size, "hardness": args.hardness,
                  ...
                  "k_sparse": args.k_sparse, "max_tw_size": args.timewindows, 'stage': args.use_sto, "device": args.device,}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_vehicles', type=int, default=3, help='num of vehicle in Team OPTWVP')
    ...
    # parser.add_argument('--device', type=str, default="cuda", choices=["cuda", "mps", "cpu"], help="the device to deploy the model")

    # model
    parser.add_argument('--tw_normalize', type=bool, default=True)
    parser.add_argument('--k_sparse', type=int, default=500, help='sparse neighbor')
    ...
    # set gpu
    #TODO: set CUDA for distributed training and modify the codes
